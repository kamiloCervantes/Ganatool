...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <title>Agregar finca @ GANATOOL</title>
 ...
 <body>
   ...
   <div id="content">
    <div class="post">
     <div id="global-actions">
      <table>
       <tr id="acciones">
        ...
        <td class="current"><a href="agregafinca.jsp">Agregar finca</a></td>
     ...
     <div id="registro" align="center">
      <div id="tituloregistro">Agregar Finca</div>
      <%
                  if (request.getParameter("aviso") != null) {
                      ...
                      if (aviso == 0) {
                          F = new Finca();
      %>
      <p class="msgok">Finca almacenada satisfactoriamente.</p>
      <%
                            } else if (aviso == 1) {
                                F = (Finca) request.getSession().getAttribute("datosFinca");
      %>
      <p class="msgerror">Ya existe una finca registrada con este NIT.</p>
      <%
                      }
                  }
      %>
      <form action="agregarfinca.do" method="post" enctype="multipart/form-data">
       <table width="600" cellspacing="0" class="estilo1_table">
        ...
        <tr>
         <td><div align="center" class="Estilo2">*</div></td>
         <td>NIT <span class="Estilo3">(no incluir el guion)</span>:</td>
         <td width="300">			  
          <div align="left">
        ...
        <tr>
         ...
         <td width="300">
          <div align="left"><span id="spryselect1">
            ...
            <span class="selectRequiredMsg">Seleccione un elemento.</span><span class="selectInvalidMsg">Seleccione un elemento.</span></span></div></td>
        </tr>
        <tr>
         <td><div align="center" class="Estilo2">*</div></td>
         <td>Municipio:</td>
         ...
         <td width="300">
          <div align="left">
           <span id="sprytextfield4">
            ...
            <span class="textfieldRequiredMsg">Se necesita un valor.</span>
            <span class="textfieldMaxCharsMsg">M&aacute;ximo 50 caracteres.</span></span>
          </div>
         </td>
        </tr>
        <tr>
         ...
         <td width="300">			 
          <div align="left">
           <span id="sprytextfield6">
            ...
            <span class="textfieldRequiredMsg">Se necesita un valor.</span>
            <span class="textfieldInvalidFormatMsg">Formato no v&aacuote;lido.</span>
           </span>
          </div>
         </td>
        </tr>
  ...
  <script type="text/javascript">
   <!--
   var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "none", {maxChars:100, validateOn:["blur", "change"]});
   ...
   var sprytextfield5 = new Spry.Widget.ValidationTextField("sprytextfield5", "none", {validateOn:["blur", "change"], maxChars:100});
