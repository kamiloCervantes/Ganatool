...
function switchSubitem(item){
 ...
 <%
              Usuario U = null;
              TablasNutricionalesCarne reg = null;
              if (request.getSession().getAttribute("usuario") != null) {
                  ...
                  if(U.getRol()!= 'a'){
                      ...
                      reg = (TablasNutricionalesCarne) request.getSession().getAttribute("tablas");
                      if (reg == null) 
		...
		<div id="content">
			<div class="post">
				<div id="modregform" class="formbox">
                                    ...
                                    <form method="post" id="modregnutricional" action="modificarregistrocarne.do?action=2">
                                    ...
                                    <p>
                                        ...
                                        <input name="forraje" id="forraje" value="<%=reg.getForraje() %>" class="validate[required,custom[number]]"/>
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        ...
                                        <input type="button" class="btn" value="Cancelar" onclick="window.location='cargarnecesidadescarne.do'"/>
                                    </p>
                                    </form>
                                </div>
