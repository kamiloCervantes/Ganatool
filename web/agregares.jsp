...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <script type="text/javascript"  language="javascript" src="js/valores.js"></script>
  <%
              int aviso = -1;
              Res R = new Res();
              Usuario U = null;
 ...
 <body>
  ...
  <div id="page">
   <div id="content">
    <div class="post"><!-- contenido de la página -->
     ...
     <div class="subsecciones">Agregar Res</div>
     <div id="registro" align="center">
      <%
                  if (request.getParameter("aviso") != null) {
                      ...
                      if (aviso == 0) {
                          R = new Res();
      %>
      <p class="msgok">La Res ha sigo agregada correctamente.</p>
      <%
                            } else if (aviso == 1) {
                                R = (Res) request.getSession().getAttribute("datosRes");
      %>
      ...
      <%                        } else {
      %>
      <form name="form1" id="form1" action="agregarres.do" method="post" enctype="multipart/form-data">
       <table width="600" cellspacing="0" class="estilo1_table">
        ...
        <tr>
         ...
         <td>Peso inicial <span class="Estilo3">(en kilogramos)</span>:</td>
         <td width="300">
          <div align="left">
        ...
        <tr>
         ...
         <td>Finca:</td>
         <td width="300">
          <div align="left"><span id="spryselect4">
         ...
         <td width="300">
          <div align="left">
           <span id="sprytextfield9">
            ...
            <span class="textfieldInvalidFormatMsg">Formato no válido.</span>
            <span class="textfieldMaxValueMsg">Ingrese un valor entre 0 y 100.</span>
           </span>
          </div>
         </td>
        </tr>
         ...
         <td width="300">
          <div align="left">
           <span id="sprytextfield7">
            <input name="cantleche2" id="cantleche2" size="50" type="text" <%=(R.getUltimoParto() != null ? "value='" + R.getCodigo() + "'" : "")%>/>
            <span class="textfieldInvalidFormatMsg">Formato no válido.</span>
           </span>
          </div>
         </td>
  ...
  <script type="text/javascript">
   ...
   var sprytextfield5 = new Spry.Widget.ValidationTextField("sprytextfield5", "none", {maxChars:50, validateOn:["blur", "change"]});
   var sprytextfield6 = new Spry.Widget.ValidationTextField("sprytextfield6", "none", {maxChars:50, validateOn:["blur", "change"]});
   var spryselect4 = new Spry.Widget.ValidationSelect("spryselect4", {validateOn:["change", "blur"]});
   var sprytextfield7 = new Spry.Widget.ValidationTextField("sprytextfield7", "date", {validateOn:["blur", "change"], isRequired:false, format:"yyyy-mm-dd"});
   var sprytextfield8 = new Spry.Widget.ValidationTextField("sprytextfield8", "real", {validateOn:["blur", "change"], isRequired:false, minValue:0});
   var sprytextfield9 = new Spry.Widget.ValidationTextField("sprytextfield9", "real", {validateOn:["blur", "change"], isRequired:false, minValue:0, maxValue:100});
   //-->
  </script>
 </body>
</html>
