     ...
     <div id="global-actions">
      <table>
       <tr id="acciones">
        ...
        <td class="current"><a href="buscares.jsp">Buscador de reses</a></td>
       </tr>
      </table>
     </div><!-- end div#global-actions -->
     <div id="reses-banner"></div>
     <div class="subsecciones">Buscar Res</div>
     <form action="buscarres.do" method="post">
      <div id="buscador-main" align="center">
       ...
       <table>
        <tr class="opcionesbusqueda">
         <td class="opcbusqueda"><input type="radio" name="tipobusqueda" value="codigo" checked="checked"/>Buscar por c&oacute;digo</td>
         <td class="opcbusqueda"><input type="radio" name="tipobusqueda" value="propietario" />Buscar por propietario</td>
        </tr>
       </table>
      </div>
     </form>
     <%
                 if (request.getSession().getAttribute("resultadoRes") != null) {
                     reses = (ArrayList<Res>) request.getSession().getAttribute("resultadoRes");
                     request.getSession().removeAttribute("resultadoRes");
                     if (reses.size() == 0) {
     %>
      ...
      <div id="resultados-info">
       <table>
        <tr>
         ...
         <td>(Paginacion)</td>
         <td>Total de resultados: <%=reses.size()%></td>
        </tr>
       </table>
      </div>
      <%
