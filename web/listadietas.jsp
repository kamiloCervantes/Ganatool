 ...
 <head>
  ...
  <%
              ...
              if (request.getSession().getAttribute("usuario") != null) {
                  ...
                  if (request.getSession().getAttribute("misdietas") != null) {
                      dietas = (ArrayList<Dieta>) request.getSession().getAttribute("misdietas");
                  } else {
   ...
   <div id="content">
    <div class="post">
     <div id="global-actions">
      <table>
       <tr id="acciones">
        <td class="current"><a href="listardietas.do">Listar dietas</a></td>
     ...
     <% if (dietas.size() == 0) {%>
     <p class="msgerror">Usted no tiene dietas generadas hasta el momento.</p>
     <% } else {%>
