...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <%
              ...
              if (request.getSession().getAttribute("usuario") != null) {
                  ...
                  if (request.getSession().getAttribute("ingredientes") != null) {
                      ingredientes = (ArrayList<Ingrediente>) request.getSession().getAttribute("ingredientes");
                  } else {
              ...
              if (request.getParameter("id") != null) {
                  ...
                  request.getSession().setAttribute("viejoid", id);
                  for (int i = 0; i < ingredientes.size(); i++) {
                      if (ingredientes.get(i).getCodigo() == id) {
                          I = ingredientes.get(i);
                          request.getSession().setAttribute("viejonombre", I.getNombre());
                      }
                  }
              } else {
                  response.sendRedirect("listaringredientes.do");
              }
  %>
  <style type="text/css">
   <!--
 ...
 <body>
   ...
   <div id="content">
    <div class="post"><!-- contenido de la página -->
     <div id="ingredientes-actions">
      <table>
       <tr id="acciones">
        <td><a href="listaingredientes.jsp">Listar ingredientes</a></td>
     ...
     <div class="subsecciones">Modificar Ingrediente <%=I.getNombre()%></div>
     <div id="registro" align="center">
      ...
      %>
      <form action="modificaringrediente.do" method="post" enctype="multipart/form-data">
  ...
  <script type="text/javascript">
   ...
   var sprytextfield8 = new Spry.Widget.ValidationTextField("sprytextfield8", "real", {validateOn:["blur", "change"], minValue:0});
   ...
   var sprytextfield12 = new Spry.Widget.ValidationTextField("sprytextfield12", "real", {validateOn:["blur", "change"]});
