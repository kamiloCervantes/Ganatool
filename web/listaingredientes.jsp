   ...
   <div id="content">
    <div class="post">
     <div id="ingredientes-actions">
      <table>
       <tr id="acciones">
        <td class="current"><a href="listaringredientes.do">Listar ingredientes</a></td>
     ...
     <div id="listaingredientes">
      ...
      %>
      <p class="msgok">El ingrediente se ha eliminado correctamente.</p>
      <%                 }
      ...
      %>
      <p class="msgerror">Usted no posee ingredientes agregados hasta ahora.</p>
      <%                           }
      %>
     </div>
    </div>
